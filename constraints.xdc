...
#set_property PACKAGE_PIN V17 [get_ports {data_bus[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[0]}]
#set_property PACKAGE_PIN V16 [get_ports {data_bus[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[1]}]
#set_property PACKAGE_PIN W16 [get_ports {data_bus[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[2]}]
#set_property PACKAGE_PIN W17 [get_ports {data_bus[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[3]}]
#set_property PACKAGE_PIN W15 [get_ports {data_bus[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[4]}]
#set_property PACKAGE_PIN V15 [get_ports {data_bus[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[5]}]
#set_property PACKAGE_PIN W14 [get_ports {data_bus[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[6]}]
#set_property PACKAGE_PIN W13 [get_ports {data_bus[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_bus[7]}]
	
#set_property PACKAGE_PIN V2 [get_ports {leds[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[0]}]
#set_property PACKAGE_PIN T3 [get_ports {leds[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[1]}]
#set_property PACKAGE_PIN T2 [get_ports {leds[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[2]}]
#set_property PACKAGE_PIN R3 [get_ports {leds[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[3]}]
#set_property PACKAGE_PIN W2 [get_ports {leds[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[4]}]
#set_property PACKAGE_PIN U1 [get_ports {leds[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[5]}]
#set_property PACKAGE_PIN T1 [get_ports {leds[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[6]}]
#set_property PACKAGE_PIN R2 [get_ports {leds[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {leds[7]}]
	
#set_property PACKAGE_PIN U16 [get_ports {bt_1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bt_1}]
#set_property PACKAGE_PIN E19 [get_ports {bt_2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bt_2}]
#set_property PACKAGE_PIN U19 [get_ports {bt_3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bt_3}]		    
...
set_property PACKAGE_PIN V2 [get_ports {d1[0]}]					
...
set_property PACKAGE_PIN T2 [get_ports {d1[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[2]}]
set_property PACKAGE_PIN R3 [get_ports {d1[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[3]}]
set_property PACKAGE_PIN W2 [get_ports {d1[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[4]}]
set_property PACKAGE_PIN U1 [get_ports {d1[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[5]}]
set_property PACKAGE_PIN T1 [get_ports {d1[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[6]}]
set_property PACKAGE_PIN R2 [get_ports {d1[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d1[7]}]
...
set_property PACKAGE_PIN W7 [get_ports {opcode[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opcode[0]}]
set_property PACKAGE_PIN W6 [get_ports {opcode[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opcode[1]}]
set_property PACKAGE_PIN U8 [get_ports {opcode[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opcode[2]}]
set_property PACKAGE_PIN V8 [get_ports {opcode[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opcode[3]}]
set_property PACKAGE_PIN U5 [get_ports {opcode[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opcode[4]}]
set_property PACKAGE_PIN V5 [get_ports {opcode[5]}]					
...
#set_property PACKAGE_PIN U7 [get_ports {opcode[6]}]					
